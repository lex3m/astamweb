...
--
-- Host: localhost    Database: astamweb
-- ------------------------------------------------------
...
CREATE TABLE `tbl_menu` (
  ...
  `parent_menu_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tbl_post` (
  ...
  CONSTRAINT `FK_category_id` FOREIGN KEY (`category_id`) REFERENCES `tbl_category` (`id`) ON DELETE CASCADE,
...
INSERT INTO `tbl_user` VALUES (1,'demo','$2a$10$JTJf6/XqC94rrOtzuF397OHa4mbmZrVTBOQCmYD9U.obZRUut4BoC','demo@mail.ru','lex','530cFVInGMZzo','administrator');
...
--
-- Table structure for table `tbl_works_image`
--

DROP TABLE IF EXISTS `tbl_works_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_works_image` (
...
--
-- Dumping data for table `tbl_works_image`
--

LOCK TABLES `tbl_works_image` WRITE;
/*!40000 ALTER TABLE `tbl_works_image` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_works_image` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-14 12:34:10
